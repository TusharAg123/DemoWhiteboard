...
export const BoardOptions = () => {
  ...
  return (
    <div className="content-container">
      ...
      <hr />
      <button onClick={() => history.push("/boardActive")}>Board Active</button>
      ...
      <button onClick={() => history.push("/boardRename")}>Board Rename</button>
      <button onClick={() => history.push("/boardDelete")}>Board Delete</button>
      <button onClick={() => history.push("/boardList")}>Board List</button>
      <button onClick={() => history.push("/boardUsage")}>Board Usage</button>
      <button onClick={() => history.push("/boardCreate")}>Board Create</button>
      <br />
